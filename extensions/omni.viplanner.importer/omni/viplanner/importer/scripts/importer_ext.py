...
from omni.viplanner.importer.importer import MatterportImporterCfg, UnRealImporterCfg
...
class OrbitNavImporterExtension(omni.ext.IExt):
    ...
    def _make_ply_proposal(self, path: str) -> None:
        ...
        - "env_id"
            - matterport_mesh
                - "id_nbr"from omni.viplanner.collectors.collectors import ViewpointSampling, ViewpointSamplingCfg
